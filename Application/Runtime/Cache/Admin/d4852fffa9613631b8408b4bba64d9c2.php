...
function doImg(obj){
    ...
    // $('#form1').attr('action','/grid_zz/index.php/Admin/Private/upload');
    // $('#form1').submit();
}
...
<div id="div_right">
	<div class="right_top">
		...
		<div class="develop">
		<form action="<?php echo ($private==null?'/grid_zz/index.php/Admin/Private/insert':'/grid_zz/index.php/Admin/Private/update'); ?>"  id="form1" method="post">
		   
		   <input type="hidden" name="id" value="<?php echo ($private["id"]); ?>" />
		   <input type="hidden" name="type" value="<?php echo ($type); ?>" />
		   
		   <table width="100%" border="0" class="mtable" >
		    <tr>
		    	<td align="right">排行</td>
		    	<td >
		    	<input type="text" id="rank" name="rank" value="<?php echo ($private["rank"]); ?>" />
		    	</td>
		    </tr>
		    <tr>
		    	<td align="right" width="20%">产品名称</td>
		    	<td width="80%"><input type="text" id="name" name="name" value="<?php echo ($private["name"]); ?>" /></td>
		     </tr>
		    <tr>
		    	<td align="right">基金经理</td>
		    	<td ><input type="text"  id="manager" name="manager" value="<?php echo ($private["manager"]); ?>" /></td>
		    </tr>
		    <tr>
		    	<td align="right">收益率</td>
		    	<td ><input type="text"  id="rate" name="rate" value="<?php echo ($private["rate"]); ?>" /></td>
		    </tr>
