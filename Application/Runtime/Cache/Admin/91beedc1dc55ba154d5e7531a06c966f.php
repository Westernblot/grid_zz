...
function doImg(obj){
    ...
    // $('#form1').attr('action','/grid_zz/index.php/Admin/Experts/upload');
    // $('#form1').submit();
}
...
<div id="div_right">
	<div class="right_top">
		...
		<div class="develop">
		<form action="<?php echo ($experts==null?'/grid_zz/index.php/Admin/Experts/insert':'/grid_zz/index.php/Admin/Experts/update'); ?>"  id="form1" method="post">
		   ...
		   <table width="100%" border="0" class="mtable" >
		    <tr>
		    	...
		    	<td colspan="3">
		    		...
		    		<img id="imgId" alt="" src="<?php echo ($experts["imgurl"]); ?>" style="width: 160px;height: 90px" >
		    		 <a href="javascript:#" id="del" onclick="delDiv(this)"><img src="/grid_zz/Public/images/remove.png" /></a>
		    		<br><input type="hidden" size="80" id="imgurl" name="imgurl" value="<?php echo ($experts["imgurl"]); ?>" />
		            </div>
		    	</td>
		    </tr>
		    <tr>
		    	<td align="right" width="20%">姓名</td>
		    	<td width="30%"><input type="text" id="name" name="name" value="<?php echo ($experts["name"]); ?>" /></td>
		        <td align="right">职位</td>
		    	<td ><input type="text"  id="position" name="position" value="<?php echo ($experts["position"]); ?>" /></td> </tr>		    
		    <tr>
		    	<td align="right">资格证号</td>
		    	<td ><input type="text"  id="code" name="code" value="<?php echo ($experts["code"]); ?>" /></td>
		    	<td align="right">星级</td>
		    	<td >
		    		<select id="star" name="star">
		    			<option value="★☆☆☆☆" <?php if(($experts["star"]) == "★☆☆☆☆"): ?>selected<?php endif; ?> >一星</option>
		    			<option value="★★☆☆☆" <?php if(($experts["star"]) == "★★☆☆☆"): ?>selected<?php endif; ?> >二星</option>
		    			<option value="★★★☆☆" <?php if(($experts["star"]) == "★★★☆☆"): ?>selected<?php endif; ?> >三星</option>
		    			<option value="★★★★☆" <?php if(($experts["star"]) == "★★★★☆"): ?>selected<?php endif; ?> >四星</option>
		    			<option value="★★★★★" <?php if(($experts["star"]) == "★★★★★"): ?>selected<?php endif; ?> >五星</option>
		    		</select>
		    ...
		    <tr>
		    	...
		    	<td colspan="3">
		    		<textarea id="introduce" name="introduce" cols="30" rows="3"><?php echo ($experts["introduce"]); ?></textarea>
		    	</td>
		    </tr>
