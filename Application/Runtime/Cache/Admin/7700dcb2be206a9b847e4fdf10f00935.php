...
function doDelete(){
	...
	//alert(ids);
	location.href='/grid_zz/index.php/Admin/Privatelist/delete?ids='+ids;
}
...
<div id="div_right">
	<div class="right_top">
				...
				<div class="title">
					<a href="/grid_zz/index.php/Admin/Privatelist/privatelistUI?type=<?php echo ($type); ?>"  class="btn btn-green">新增</a> 				
		...
		<div class="develop"  >
					...
					<tbody id="goaler">
						<?php if(empty($privatelistList)): ?><tr>
							<td colspan="5" align="center"><font color="red">暂无记录</font></td>
						</tr><?php endif; ?>
						
						<?php if(is_array($privatelistList)): foreach($privatelistList as $key=>$vo): ?><tr id="<?php echo ($vo["id"]); ?>">
						         ...
						         <td>
						         	<a href="/grid_zz/index.php/Admin/Privatelist/privatelistUI?id=<?php echo ($vo["id"]); ?>&type=<?php echo ($type); ?>">编辑</a>&nbsp;					         	
						         </td>						 					         
