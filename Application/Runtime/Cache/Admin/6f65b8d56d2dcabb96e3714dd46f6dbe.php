...
function doImg(obj){
    ...
    // $('#form1').attr('action','/grid_zz/index.php/Admin/Link/upload');
    // $('#form1').submit();
}
...
<div id="div_right">
	<div class="right_top">
		...
		<div class="develop">
		<form action="<?php echo ($link==null?'/grid_zz/index.php/Admin/Link/insert':'/grid_zz/index.php/Admin/Link/update'); ?>"  id="form1" method="post">
		   ...
		   <table width="100%" border="0" class="mtable" >
		     ...
		     <?php if(!in_array(($type), explode(',',"友情链接,行销支持"))): ?><tr>
		   ...
		   <?php if(!in_array(($type), explode(',',"中证金牛V计划"))): ?><tr>
