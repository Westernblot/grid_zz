...
function doDelete(){
	...
	//alert(ids);
	location.href='/grid_lyj/index.php/Admin/Myzj/delete?ids='+ids;
}
...
<div id="div_right">
	<div class="right_top">
				...
				<div class="title">
					<a href="<?php echo U('myzjUI');?>"  class="btn btn-green">新增</a> 				
		...
		<div class="develop"  >
					...
					<tbody id="goaler">
						<?php if(empty($myzjList)): ?><tr>
							<td colspan="5" align="center"><font color="red">暂无记录</font></td>
						</tr><?php endif; ?>
						
						<?php if(is_array($myzjList)): foreach($myzjList as $key=>$vo): ?><tr id="<?php echo ($vo["id"]); ?>">
						         ...
						         <td>
						         	<a href="<?php echo U('myzjUI',array('id'=>$vo['id']));?>">编辑</a>&nbsp;
						         	<a href="<?php echo U('myzjSee',array('id'=>$vo['id']));?>">查看征集意见</a>&nbsp;
